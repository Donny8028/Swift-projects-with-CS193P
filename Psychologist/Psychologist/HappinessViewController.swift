...
class HappinessViewController: UIViewController, FaceViewDateSource {
    ...
    @IBOutlet weak var faceView: Face!{
        didSet{
            ...
            faceView.addGestureRecognizer(UIPinchGestureRecognizer(target: faceView, action: "pinchable:"))
            faceView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: "tappable:"))
        }
    }
